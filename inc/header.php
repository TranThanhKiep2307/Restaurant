	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item <?php echo ($activate == "contact" ? "active" : "")?>"><a href="contact.php" class="nav-link">Liên hệ</a></li>	          <li class="nav-item cta"><a href="reservation.php" class="nav-link">Đặt bàn</a></li>
			  <li class="nav-item <?php echo ($activate == "contact" ? "active" : "")?>"><a href="" class="nav-link icon-user"></a></li>	        </ul>
	      </div>
	    </div>
	  </nav>
    <!-- END nav -->