      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center mb-4">
            <h1 class="mb-2 bread">Giới thiệu</h1>
		...
		<section class="ftco-section ftco-wrap-about">
			<div class="container">
	          ...
	          <div class="heading-section mb-4 my-5 my-md-0">
	            ...
	            <h2 class="mb-4">Nhà hàng FOXXOF</h2>
	          </div>
            <p>Từ ngày ra mắt đến nay, nhà hàng của chúng tôi đã chào đón hơn 100 người nổi tiếng và tổ chức hàng loạt hội nghị quốc tế. Nhiều năm qua, chúng tôi thực sự đã nhận được sự công nhận từ quốc tế.</p>
	          <p>Món ăn gia truyền kết hợp với các món Tây Âu có hương vị cực ngon, không gian nhà hàng ấm áp như ở nhà. Sang trọng như khách sạn 5 sao, cho khách hàng cảm giác như bước chân vào thư viện châu Âu cổ xưa với ngàn vạn quyển sách xếp chồng lên nhau.</p>
						<pc class="time">
							<span>Từ thứ Hai đến Chủ nhật <strong>8 AM - 9 PM</strong></span>
    	...
    	<div class="container">
          ...
          <div class="col-md-3 text-center text-md-left">
          	<p>Nhà hàng chúng tôi với hơn 5 năm kinh doanh, 42 món ăn cùng với 50 nhân viên đã phục vụ cho hơn 15.000 khách hàng. </p>
          </div>
        </div>
    	</div>
    </section>
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Không gian sang trọng bậc nhất, menu vô cùng phong phú và mới lạ cùng đội ngũ nhân viên chuyên nghiệp, nhiệt thành.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Nhà hàng FOXXOF là địa chỉ quen thuộc đối với nhiều thực khách sành ăn. Không chỉ mang đến những món ăn hội tụ tinh hoa ẩm thực,Nhà hàng còn là không gian lý tưởng để tổ chức các buổi tiệc liên hoan, họp mặt.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body p-2 mt-3">
                ...
                <p>Là trung tâm tổ chức sự kiện & tiệc cưới hoành tráng, sang trọng bậc nhất.</p>
                <p>Không gian sang trọng vị trí vàng.</p>
                <p>Luôn hướng đến việc mang đến những trải nghiệm dịch vụ tiệc hoàn hảo.</p>
              </div>
            </div>      
          </div>
        </div>
		...
		<section class="ftco-section">
          ...
          <div class="col-md-12 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-4">Đầu Bếp giỏi của chúng tôi</h2>
          </div>
        </div>	
				<div class="row">
